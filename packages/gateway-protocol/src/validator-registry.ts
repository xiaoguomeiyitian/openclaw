...
export const validateScmStatusParams = compile(S.ScmStatusParamsSchema);
export const validateScmDiffParams = compile(S.ScmDiffParamsSchema);
export const validateScmStageParams = compile(S.ScmStageParamsSchema);
export const validateScmUnstageParams = compile(S.ScmUnstageParamsSchema);
export const validateScmCommitParams = compile(S.ScmCommitParamsSchema);
export const validateScmBranchesParams = compile(S.ScmBranchesParamsSchema);
export const validateScmCheckoutParams = compile(S.ScmCheckoutParamsSchema);
export const validateScmCheckoutNewParams = compile(S.ScmCheckoutNewParamsSchema);
export const validateScmFetchParams = compile(S.ScmFetchParamsSchema);
export const validateScmPullParams = compile(S.ScmPullParamsSchema);
export const validateScmPushParams = compile(S.ScmPushParamsSchema);
export const validateScmLogParams = compile(S.ScmLogParamsSchema);
export const validateScmConflictsParams = compile(S.ScmConflictsParamsSchema);
export const validateScmResolveParams = compile(S.ScmResolveParamsSchema);
