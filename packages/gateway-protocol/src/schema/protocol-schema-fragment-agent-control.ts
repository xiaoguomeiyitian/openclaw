...
export const AgentControlProtocolSchemas = {
  ...
  ScmBranchesParams: scm.ScmBranchesParamsSchema,
  ScmBranch: scm.ScmBranchSchema,
  ScmBranchesResult: scm.ScmBranchesResultSchema,
  ScmCheckoutParams: scm.ScmCheckoutParamsSchema,
  ScmCheckoutNewParams: scm.ScmCheckoutNewParamsSchema,
  ScmFetchParams: scm.ScmFetchParamsSchema,
  ScmPullParams: scm.ScmPullParamsSchema,
  ScmPushParams: scm.ScmPushParamsSchema,
  ScmLogParams: scm.ScmLogParamsSchema,
  ScmCommitInfo: scm.ScmCommitInfoSchema,
  ScmLogResult: scm.ScmLogResultSchema,
  ScmConflictsParams: scm.ScmConflictsParamsSchema,
  ScmConflictsResult: scm.ScmConflictsResultSchema,
  ScmResolveParams: scm.ScmResolveParamsSchema,
