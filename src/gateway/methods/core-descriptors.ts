...
const CORE_GATEWAY_METHOD_SPECS = [
  ...
  ["scm.branches", "scm", "operator.write", "2026.9"],
  ["scm.checkout", "scm", "operator.write", "2026.9"],
  ["scm.checkoutNew", "scm", "operator.write", "2026.9"],
  ["scm.fetch", "scm", "operator.write", "2026.9"],
  ["scm.pull", "scm", "operator.write", "2026.9"],
  ["scm.push", "scm", "operator.write", "2026.9"],
  ["scm.log", "scm", "operator.write", "2026.9"],
  ["scm.conflicts", "scm", "operator.write", "2026.9"],
  ["scm.resolve", "scm", "operator.write", "2026.9"],
