...
export const en: TranslationMap & {
  ...
  scm: {
    clean: "No changes. The working tree is clean.",
    groupStaged: "Staged",
    groupChanges: "Changes",
    groupUntracked: "Untracked",
    groupMerge: "Merge Conflicts",
    emptyStaged: "No staged changes.",
    emptyChanges: "No unstaged changes.",
    emptyUntracked: "No untracked files.",
    emptyMerge: "No merge conflicts.",
    stageFile: "Stage file",
    unstageFile: "Unstage file",
    selectFile: "Select a file to preview its diff.",
    ...
    createBranchFrom: "Create a new branch from the current one",
    sync: "Sync",
    fetch: "Fetch",
    pull: "Pull",
    push: "Push",
  ...
  chat: {
    ...
    sidePanel: {
      ...
      scm: "Source Control",
      scmEmpty: "Review and commit git changes for this session\u2019s workspace.",
    },
    thread: {
